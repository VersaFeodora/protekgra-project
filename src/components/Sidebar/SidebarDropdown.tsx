          ...
          <li key={index}>
            <Link
              ...
              className={`relative flex rounded-[7px] px-3.5 py-2 font-medium duration-300 ease-in-out ${
                pathname === item.route
                  ? "bg-violet-900/[.5] text-white dark:bg-white/10 dark:text-white"
                  : "text-dark-4 hover:bg-purple-200 hover:text-dark dark:text-gray-5 dark:hover:bg-white/10 dark:hover:text-white"
              }`}
            >
              {item.label}
              {item.pro && (
