...
const FilterDate = ({ onSubmit }:FilterDateProps) => {
  ...
  return (
    ...
    <button
                    className="flex flex-row gap-3 rounded-[7px] bg-violet-500 px-6 py-3 font-medium text-gray-2 hover:bg-opacity-90 dark:bg-opacity-50 dark:hover:bg-opacity-60"
                    type="submit"
                  >
    ...
    <button
                    className="flex flex-row gap-3 rounded-[7px] bg-yellow-500 px-6 py-3 font-medium text-gray-2 hover:bg-opacity-90 dark:bg-opacity-50 dark:hover:bg-opacity-60"
                    type="button"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6z"/><path d="M14 3v5h5M16 13H8M16 17H8M10 9H8"/></svg>
                    Generate PDF
                  </button>
    </div>
        </div>
